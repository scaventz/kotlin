...
fun test() {
    ...
    val b: Byte = <!TYPE_MISMATCH{NI}, TYPE_MISMATCH{NI}, TYPE_INFERENCE_EXPECTED_TYPE_MISMATCH{OI}!>id(300)<!>

    val c: Int = <!TYPE_MISMATCH{NI}, TYPE_MISMATCH{NI}, TYPE_INFERENCE_EXPECTED_TYPE_MISMATCH{OI}!>id(9223372036854775807)<!>
    ...
    val g: Byte = <!TYPE_MISMATCH{NI}, TYPE_MISMATCH{NI}, TYPE_INFERENCE_EXPECTED_TYPE_MISMATCH{OI}!>either(1, 300)<!>
