...
fun test() {
    ...
    a.<!DEBUG_INFO_UNRESOLVED_WITH_TARGET{NI}, UNRESOLVED_REFERENCE_WRONG_RECEIVER{NI}, DEBUG_INFO_ELEMENT_WITH_ERROR_TYPE{OI}, TYPE_INFERENCE_UPPER_BOUND_VIOLATED{OI}!>linkedProjectsSettings<!>
}
