...
fun test1(int: Int, any: Any) {
    ...
    val a1 : MyList<Int> = <!TYPE_MISMATCH{NI}, TYPE_MISMATCH{NI}, TYPE_INFERENCE_EXPECTED_TYPE_MISMATCH{OI}!>getMyList(any)<!>
    ...
    val a9 : MyList<in Any> = <!TYPE_MISMATCH{NI}, TYPE_MISMATCH{NI}, TYPE_INFERENCE_EXPECTED_TYPE_MISMATCH{OI}!>getMyListToReadFrom(int)<!>

    val a10 : MyList<out Int> = <!TYPE_MISMATCH{NI}, TYPE_MISMATCH!>getMyList<Any>(any)<!>
    val a11 : MyList<out Int> = <!TYPE_MISMATCH{NI}, TYPE_MISMATCH{NI}, TYPE_INFERENCE_EXPECTED_TYPE_MISMATCH{OI}!>getMyList(any)<!>

    val a12 : MyList<out Int> = <!TYPE_MISMATCH{NI}, TYPE_MISMATCH!>getMyListToWriteTo<Any>(any)<!>
    val a13 : MyList<out Int> = <!TYPE_MISMATCH{NI}, TYPE_MISMATCH{NI}, TYPE_INFERENCE_EXPECTED_TYPE_MISMATCH{OI}!>getMyListToWriteTo(any)<!>
    ...
    readFromMyList<Int>(<!TYPE_MISMATCH{NI}, TYPE_MISMATCH{NI}, TYPE_INFERENCE_EXPECTED_TYPE_MISMATCH{OI}!>getMyList(any)<!>, int)

    readFromMyList<Int>(<!TYPE_MISMATCH{NI}, TYPE_INFERENCE_EXPECTED_TYPE_MISMATCH{OI}!>getMyListToReadFrom(any)<!>, int)
