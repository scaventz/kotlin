...
//in a class
class A() {
    val x = { <!DEBUG_INFO_MISSING_UNRESOLVED{NI}, UNINITIALIZED_VARIABLE{OI}, TYPECHECKER_HAS_RUN_INTO_RECURSIVE_PROBLEM!>x<!> }
}
...
val z = <!DEBUG_INFO_MISSING_UNRESOLVED{NI}, UNINITIALIZED_VARIABLE{OI}, TYPECHECKER_HAS_RUN_INTO_RECURSIVE_PROBLEM!>z<!>
