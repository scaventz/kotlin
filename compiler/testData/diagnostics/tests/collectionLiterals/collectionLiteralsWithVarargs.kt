...
@Ann1(*<!TYPE_MISMATCH{NI}, TYPE_MISMATCH{NI}, TYPE_INFERENCE_EXPECTED_TYPE_MISMATCH{OI}!>["a", 1, <!ANNOTATION_ARGUMENT_MUST_BE_CONST!>null<!>]<!>)
fun test1_2() {}
...
@Ann1(<!TYPE_MISMATCH{NI}, TYPE_INFERENCE_EXPECTED_TYPE_MISMATCH{OI}, TYPE_MISMATCH!>[""]<!>)
fun testVararg() {}
